...
int const       MCC         = 2000000;          /* number of function calls for Monte Carlo integration 2000000 */
...
int const       harmonics   = 1;                /* Fourier harmonics for optical conductivity */

/*
Note 1.
 Freq Range  : Accessible Max Field
 0.xx - 0.xx : 0.09
 0.xx - 0.22 : 0.19
 0.23 - 0.xx : 0.39
 0.xx - 0.32 : 0.79
...
Note 2.
 How to merge separate data files:
 paste OptCond_Ec10_T002_F100_Group1 OptCond_Ec10_T002_F100_Group2 OptCond_Ec10_T002_F100_Group3 OptCond_Ec10_T002_F100_Group4 OptCond_Ec10_T002_F100_Group5 | awk '{print $1, $2, sprintf("%.6e", ($3+$8+$13+$18+$23)/5.0), sprintf("%.6e", ($4+$9+$14+$19+$24)/5.0), sprintf("%.6e", atan2(($4+$9+$14+$19+$24)/5.0,($3+$8+$13+$18+$23)/5.0))}'
*/
